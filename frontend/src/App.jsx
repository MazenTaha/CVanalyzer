...
const resultSections = [
  ...
  { key: "atsSuggestions", title: "ATS Optimization Suggestions", type: "list" },
  { key: "interviewPreparation", title: "Interview Preparation Advice", type: "list" },
  ...
  async function handleAnalyze(event) {
    ...
    try {
      ...
      if (trimmedText) {
        ...
        // This creates a clearer two-stage experience even though extraction and analysis
        // happen within a single backend request.
      ...
      <main className="app">
        <section className="hero">
          ...
          <p className="hero-copy">
            Analyze pasted CV text or upload a PDF resume to get recruiter-style feedback,
            ATS improvements, missing skill suggestions, and interview preparation advice.
          </p>
        </section>
            ...
            <div className="input-grid">
              ...
              <div className="input-column">
                ...
                >
                  ...
                  <p className="dropzone-meta">Supported format: PDF only, up to 5MB</p>
                </div>
